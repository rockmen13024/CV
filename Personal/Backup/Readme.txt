...
This script makes backup after folders or files in backup_list.txt and puts them on the
cloud under a name that specifies the day. It also makes a News file and Errors log on desktop where you can find a message
